 ...
 * @prop {Record<'base'|'ansi'|'brightOther'|'other', string[]>} owldarker - Owl Darker color variables.
...
const transformSoft = theme => {
    ...
    const brightColors = [...soft.owldarker.ansi, ...soft.owldarker.brightOther];
...
module.exports = async () => {
    const yamlFile = await readFile(
        join(__dirname, '..', 'src', 'owldarker.yml'),
        'utf-8'
    );
